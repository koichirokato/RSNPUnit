...
class RSNPUnitConnectorTest(OpenRTM_aist.DataFlowComponentBase):
	...
	def __init__(self, manager):
		...
		self._d_SampleDataIn = OpenRTM_aist.instantiateDataType(RTC.TimedString)
		"""
		"""
		self._SampleDataInOut = OpenRTM_aist.OutPort("SampleDataIn", self._d_SampleDataIn)
	...
	def onInitialize(self):
		...
		# Set OutPort buffers
		self.addOutPort("SampleDataIn",self._SampleDataInOut)
